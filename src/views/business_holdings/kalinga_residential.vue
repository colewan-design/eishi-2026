    ...
    <v-container v-if="!isMobileView" style="padding-top: 10rem;">
        <v-row>
            <v-col cols="9" class="mx-auto">
                <div>
                    <p style="font-size: 4.5rem;">{{ t.residentialLands }}</p style="font-size: 5rem;">
                    <p style="margin-top: 3rem; font-size: 1rem;" class="text-blue-grey-darken-2">
                        {{ t.residentialLotsDescription }}
                    </p>
                </div>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col cols="9" class="mx-auto">
                <v-parallax src="/eishi/kalinga_residential/images/DJI_0595-min.webp" height="calc(100vh - 200px)">
                </v-parallax>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col class="mx-auto" cols="9">
                <v-container>
                    <v-row>
                        <v-col>
                            <p class="text-body-1 text-blue-grey-darken-2 ">{{ t.residentialLandsP1 }}</p>
                            <p class="text-body-1 text-blue-grey-darken-2 mt-4">{{ t.residentialLandsP2 }}</p>
                        </v-col>
                        <v-col>
                            <div class="farm-table">
                                <div class="row-item">
                                    <div class="label">{{ t.kalingaNameLabel }}</div>
                                    <div class="value">{{ t.kalingaNameValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.kalingaLocationLabel }}</div>
                                    <div class="value">{{ t.kalingaLocationValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.acquisitionDateLabel }}</div>
                                    <div class="value">{{ t.acquisitionDateValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.kalingaPurposeLabel }}</div>
                                    <div class="value">{{ t.purposeValue }}</div>
                                </div>

                                <!-- 3-column group -->
                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">{{ t.numberOfLotsLabel }}</div>
                                        <div class="value">{{ t.numberOfLotsValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.expectedGrowthLabel }}</div>
                                        <div class="value">{{ t.expectedGrowthValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.strategicLocationLabel }}</div>
                                        <div class="value">{{ t.strategicLocationValue }}</div>
                                    </div>
                                </div>
                            </div>
                        </v-col>
                        ...
                        <v-col class="mx-auto">
                            <div class="video-wrapper">
                                <video autoplay loop muted playsinline preload="metadata" poster="/images/hero-img.jpg">
                                    <source src="/eishi/videos/residential.webm" type="video/mp4" />
                                </video>
                            </div>
                        </v-col>
                    </v-row>
                    ...
                    <v-row>
                        <v-col class="mx-auto">
                            <div class="map-container">
                                ...
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d145461.78248305916!2d121.32393399129406!3d17.408449490430563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x338f99c3d1c5399b%3A0xc919e747c62ce9f4!2sCity%20of%20Tabuk%2C%20Kalinga!5e1!3m2!1sen!2sph!4v1764209427875!5m2!1sen!2sph"
                        ...
                        <v-col v-for="(property, index) in translatedProperties" :key="index" cols="6">
                            <v-card class="overflow-hidden cursor-pointer" variant="text"
                                ...
                                <v-card-text>
                                    <div class="farm-table">
                                        <div class="row-item">
                                            <div class="label">{{ t.propertyName }}</div>
    ...
    <div v-if="isMobileView" style="padding-top: 5rem;">
        ...
        <v-container>
            <v-row>
                <v-col>
                    <div>
                        <p style="font-size: 2.5rem;">{{ t.residentialLands }}</p style="font-size: 5rem;">
...
export default {
    ...
    data() {
        return {
            ...
            images: [
                '/eishi/kalinga_residential/images/DJI_0591-min.webp',
                '/eishi/kalinga_residential/images/DJI_0595-min.webp',
                '/eishi/kalinga_residential/images/DJI_0598+(1)-min.webp',
            ],
        };
    },
