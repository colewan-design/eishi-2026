    ...
    <v-container v-if="!isMobileView" style="padding-top: 10rem;">
        <v-row>
            <v-col cols="9" class="mx-auto">
                <div>
                    <p style="font-size: 4.5rem;">{{ t.carRental }}</p style="font-size: 5rem;">
                    <p style="margin-top: 3rem; font-size: 1rem;" class="text-blue-grey-darken-2">
                        {{ t.carRentalDescription }}
                    </p>
                </div>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col cols="9" class="mx-auto">
                <v-parallax src="/eishi/car_rental/images/car01.webp" height="calc(100vh - 200px)">
                </v-parallax>
            </v-col>
        </v-row>
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <div class="farm-table">
                                <div class="row-item">
                                    <div class="label">{{ t.carRentalDetails.businessNameLabel }}</div>
                                    <div class="value">{{ t.carRentalDetails.businessNameValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.carRentalDetails.operatingAreaLabel }}</div>
                                    <div class="value">{{ t.carRentalDetails.operatingAreaValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.carRentalDetails.primaryUseLabel }}</div>
                                    <div class="value">{{ t.carRentalDetails.primaryUseValue }}</div>
                                </div>

                                <div class="row-item">
                                    <div class="label">{{ t.carRentalDetails.ownershipLabel }}</div>
                                    <div class="value">{{ t.carRentalDetails.ownershipValue }}</div>
                                </div>

                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.vehicleOriginLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.vehicleOriginValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.maintenanceStandardLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.maintenanceStandardValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.comfortLevelLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.comfortLevelValue }}</div>
                                    </div>
                                </div>

                                <div class="row-group">
                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.customerBaseLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.customerBaseValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.popularWithLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.popularWithValue }}</div>
                                    </div>

                                    <div class="row-item small">
                                        <div class="label">{{ t.carRentalDetails.valuePropositionLabel }}</div>
                                        <div class="value">{{ t.carRentalDetails.valuePropositionValue }}</div>
                                    </div>
                                </div>
                            </div>
                        </v-col>
                        ...
                        <v-col class="mx-auto">
                            <div class="video-wrapper">
                                <video autoplay loop muted playsinline preload="metadata" poster="/images/hero-img.jpg">
                                    <source src="/eishi/videos/car rental.webm" type="video/mp4" />
                                </video>
                            </div>
                        </v-col>
                    </v-row>
    ...
    <div v-if="isMobileView" style="padding-top: 5rem;">
        ...
        <v-container>
            <v-row>
                <v-col>
                    <div>
                        <p style="font-size: 2.5rem;">{{ t.carRental }}</p style="font-size: 5rem;">
...
export default {
    ...
    data() {
        return {
            ...
            images: [
                '/eishi/car_rental/images/car01.webp',
                '/eishi/car_rental/images/car02.webp',
                '/eishi/car_rental/images/car03.webp',
                '/eishi/car_rental/images/car04.webp',
